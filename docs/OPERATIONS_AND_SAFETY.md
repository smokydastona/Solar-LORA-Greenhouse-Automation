...
- The OLED shifts into a dim animated screensaver after several idle minutes to reduce burn-in. Wake it with any local mode button or another mode-changing action before treating the display as faulty.
