...
- The onboard OLED now falls back to a low-contrast procedural screensaver after prolonged idle time instead of holding a static status page indefinitely.
