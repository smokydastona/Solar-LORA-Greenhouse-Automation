...
class GreenhouseController {
 ...
 private:
  ...
  String buildUiHead(const char *title) const {
    ...
    html += F(":root{color-scheme:dark;--bg:#071017;--bg-top:#101a24;--bg-edge:#050a0f;--panel:rgba(12,18,28,.90);--panel-soft:rgba(19,29,42,.88);--panel-strong:#0f1c29;--text:#e8f0f5;--muted:#8fa6b5;--line:rgba(129,165,178,.16);--line-strong:rgba(129,165,178,.28);--accent:#59d7a0;--accent-strong:#39b685;--accent-soft:rgba(89,215,160,.14);--accent-alt:#75c9ff;--ok:#72d98f;--warn:#e4c065;--danger:#f0818e;--shadow:0 26px 64px rgba(0,0,0,.36);--hero-a:#0f1d2a;--hero-b:#143346;--hero-c:#0f2d28;--font-body:'Bahnschrift','Segoe UI Variable Text','Segoe UI',system-ui,sans-serif;--font-display:'Segoe UI Variable Display','Bahnschrift','Segoe UI',sans-serif;--space-1:8px;--space-2:12px;--space-3:16px;--space-4:20px;--space-5:28px;}html[data-theme='light']{color-scheme:light;--bg:#edf2f6;--bg-top:#f8fbfd;--bg-edge:#dfe8ef;--panel:rgba(255,255,255,.90);--panel-soft:rgba(243,248,251,.96);--panel-strong:#ffffff;--text:#15232c;--muted:#607483;--line:rgba(73,104,120,.16);--line-strong:rgba(73,104,120,.28);--accent:#1f8c68;--accent-strong:#187354;--accent-soft:rgba(31,140,104,.10);--accent-alt:#2e89c7;--ok:#2e8b57;--warn:#a06d14;--danger:#b64a57;--shadow:0 22px 52px rgba(17,39,51,.12);--hero-a:#183546;--hero-b:#20556b;--hero-c:#18463c;}*{box-sizing:border-box;}html,body{min-height:100%;scroll-behavior:smooth;}body{margin:0;font-family:var(--font-body);background:radial-gradient(circle at top,var(--bg-top) 0,var(--bg) 54%,var(--bg-edge) 100%);color:var(--text);font-size:14px;line-height:1.48;letter-spacing:.008em;text-rendering:optimizeLegibility;}body:before{content:'';position:fixed;inset:0;background:linear-gradient(140deg,rgba(117,201,255,.08),transparent 28%),linear-gradient(220deg,rgba(89,215,160,.08),transparent 34%),radial-gradient(circle at 18% 16%,rgba(89,215,160,.10),transparent 18%);pointer-events:none;}main{position:relative;max-width:1180px;margin:0 auto;padding:18px 16px 42px;}section{background:var(--panel);backdrop-filter:blur(14px);border:1px solid var(--line);border-radius:22px;padding:16px;margin-bottom:14px;box-shadow:var(--shadow);}h1,h2,h3,.app-brand strong,.page-nav a,.pill,.kicker,label,button{font-family:var(--font-display);}h1,h2{margin:0 0 var(--space-2);line-height:1;letter-spacing:-.03em;}h1{font-size:2rem;font-weight:800;}h2{font-size:1rem;font-weight:800;text-transform:uppercase;letter-spacing:.12em;color:var(--muted);}h3{margin:0 0 var(--space-1);color:var(--text);font-size:.96rem;letter-spacing:.01em;}p{line-height:1.5;margin:0 0 var(--space-2);}a{color:var(--accent-alt);text-decoration:none;}a:hover{text-decoration:underline;}code{background:rgba(117,201,255,.10);padding:2px 6px;border-radius:6px;font-size:.92em;}.theme-shell{display:flex;justify-content:space-between;align-items:center;gap:var(--space-2);margin-bottom:10px;padding:10px 12px;border:1px solid var(--line);border-radius:18px;background:rgba(7,13,20,.52);backdrop-filter:blur(10px);}html[data-theme='light'] .theme-shell{background:rgba(255,255,255,.74);} .app-brand{display:flex;flex-direction:column;gap:2px;} .app-brand strong{font-size:.9rem;letter-spacing:.12em;text-transform:uppercase;line-height:1;} .app-brand span{font-size:.76rem;color:var(--muted);letter-spacing:.02em;} .theme-switcher{display:inline-flex;align-items:center;gap:8px;padding:7px 9px;border-radius:999px;background:rgba(10,16,24,.42);border:1px solid var(--line);backdrop-filter:blur(10px);} html[data-theme='light'] .theme-switcher{background:rgba(255,255,255,.78);} .theme-switcher label{margin:0;font-size:.72rem;letter-spacing:.14em;text-transform:uppercase;color:var(--muted);font-weight:700;} .theme-switcher select{width:auto;min-width:108px;margin:0;padding:7px 30px 7px 10px;border-radius:999px;} .page-nav{display:flex;flex-wrap:wrap;gap:7px;margin:0 0 12px;padding:0;list-style:none;} .page-nav a{display:inline-flex;align-items:center;padding:8px 11px;border-radius:999px;background:rgba(13,20,30,.58);border:1px solid var(--line);color:var(--text);font-size:.76rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;line-height:1;} html[data-theme='light'] .page-nav a{background:rgba(255,255,255,.82);} .page-nav a:hover{text-decoration:none;border-color:var(--line-strong);background:var(--accent-soft);} .hero{background:linear-gradient(145deg,var(--hero-a),var(--hero-b) 58%,var(--hero-c));border:none;color:#eef8fb;overflow:hidden;position:relative;padding:18px;} .hero:after{content:'';position:absolute;inset:auto -12% -42% auto;width:360px;height:360px;background:radial-gradient(circle,rgba(117,201,255,.18),transparent 62%);pointer-events:none;} .hero h1,.hero strong{color:#f7fcff;} .hero p{color:#d6e6ee;max-width:64ch;} .hero-grid{display:grid;grid-template-columns:minmax(0,1.8fr) minmax(280px,1fr);gap:16px;align-items:start;} .kicker{display:inline-flex;align-items:center;padding:5px 9px;border-radius:999px;border:1px solid rgba(232,241,244,.14);background:rgba(232,241,244,.08);font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;margin-bottom:10px;font-weight:800;line-height:1;} .grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:10px;} .card{background:var(--panel-soft);border-radius:18px;padding:12px 13px;border:1px solid var(--line);position:relative;overflow:hidden;line-height:1.42;} .card:before{content:'';position:absolute;inset:0 auto 0 0;width:3px;background:linear-gradient(180deg,var(--accent-alt),transparent 60%);opacity:.8;} .card strong{font-weight:800;} .card > strong:first-child{display:block;font-size:.72rem;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);margin-bottom:6px;line-height:1.1;} .hero .card{background:rgba(232,241,244,.10);border-color:rgba(232,241,244,.14);color:#f4fbff;} .hero .card:before{background:linear-gradient(180deg,rgba(117,201,255,.85),transparent 60%);} .hero .card strong{display:block;font-size:1.52rem;line-height:1;margin-top:4px;} .hero .card span{display:block;font-size:.68rem;letter-spacing:.14em;text-transform:uppercase;color:#d6e7ef;font-weight:800;line-height:1.1;}label{display:block;font-weight:800;margin:8px 0 5px;font-size:.76rem;letter-spacing:.08em;text-transform:uppercase;}input,textarea,select{width:100%;padding:9px 11px;border:1px solid rgba(129,165,178,.22);border-radius:12px;box-sizing:border-box;font:inherit;background:rgba(8,14,21,.68);color:var(--text);} html[data-theme='light'] input,html[data-theme='light'] textarea,html[data-theme='light'] select{background:#fff;}textarea{min-height:84px;resize:vertical;}button{margin-top:10px;padding:9px 13px;border:none;border-radius:12px;background:linear-gradient(135deg,var(--accent),var(--accent-strong));color:#06120f;font-size:.78rem;font-weight:800;cursor:pointer;letter-spacing:.06em;text-transform:uppercase;line-height:1;}button.secondary{background:linear-gradient(135deg,#395264,#567488);color:#eef6fb;} html[data-theme='light'] button.secondary{color:#fff;} .action-row{display:flex;flex-wrap:wrap;gap:8px;margin-top:10px;} .action-row button{margin-top:0;} .muted{color:var(--muted);} .notice{background:linear-gradient(135deg,rgba(117,201,255,.08),rgba(89,215,160,.06));border:1px solid rgba(117,201,255,.12);border-left:5px solid var(--accent-alt);border-radius:16px;padding:11px 13px;margin:10px 0;} .status-note{min-height:1.3em;margin-top:8px;font-size:.84rem;line-height:1.45;} .pill-row{display:flex;flex-wrap:wrap;gap:8px;margin:10px 0 0;} .pill{display:inline-flex;align-items:center;padding:6px 10px;border-radius:999px;background:var(--accent-soft);border:1px solid rgba(89,215,160,.18);font-size:.72rem;font-weight:800;letter-spacing:.09em;text-transform:uppercase;color:var(--text);line-height:1;} .pill.ok{background:rgba(114,217,143,.16);color:var(--ok);border-color:rgba(114,217,143,.24);} .pill.warn{background:rgba(228,192,101,.15);color:var(--warn);border-color:rgba(228,192,101,.22);} .pill.danger{background:rgba(240,129,142,.14);color:var(--danger);border-color:rgba(240,129,142,.24);} .section-intro{margin-top:-1px;margin-bottom:10px;max-width:62ch;font-size:.9rem;line-height:1.46;} .metric-strip{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;margin-top:14px;} .message-wrap{max-width:760px;margin:0 auto;} .message-card{padding:20px;} .message-card h1{margin-bottom:8px;} @media (max-width:860px){.hero-grid{grid-template-columns:1fr;}.theme-shell{align-items:flex-start;flex-direction:column;}} @media (max-width:640px){body{font-size:13px;}main{padding:14px 12px 32px;}section,.hero{padding:14px;border-radius:18px;}.theme-shell{justify-content:stretch;}.theme-switcher{width:100%;justify-content:space-between;}.page-nav a{width:100%;justify-content:center;}} </style></head><body><main>");
    return html;
  }

  String buildUiThemeControl() const {
    return F("<div class='theme-shell'><div class='app-brand'><strong>Mini Greenhouse Node</strong><span>Local operator dashboard and field controls</span></div><div class='theme-switcher'><label for='theme-mode'>Theme</label><select id='theme-mode'><option value='auto'>Auto</option><option value='dark'>Dark</option><option value='light'>Light</option></select></div></div>");
  }
  ...
  String buildDashboardHtml() const {
    ...
    html += buildUiThemeControl();
    html += F("<nav class='page-nav'><a href='#operations'>Overview</a><a href='#identity'>Access</a>");
    if (WiFi.status() == WL_CONNECTED) {
      html += F("<a href='#live-dashboard'>Live</a><a href='#climate-settings'>Climate</a><a href='#display-settings'>Display</a>");
    }
    html += F("<a href='#wifi-config'>Wi-Fi</a><a href='#update-firmware'>Firmware</a></nav>");
    ...
    html += F("</div><div class='metric-strip'>");
    ...
    html += F("<section id='identity'><h2>Access and identity</h2><p class='muted section-intro'>Use the joined station address when Wi-Fi is available. If the node cannot join Wi-Fi, the setup access point remains the recovery path.</p>");
    if (WiFi.status() == WL_CONNECTED) {
    ...
    if (WiFi.status() == WL_CONNECTED) {
      ...
      html += F("<section id='climate-settings'><h2>Climate Settings</h2><p class='muted'>Save updated climate thresholds directly from the station dashboard. Editing requires the current station Wi-Fi password, or the node setup password if the station network is open.</p>");
      ...
      html += F("<section id='display-settings'><h2>Display Settings</h2><p class='muted'>Choose whether OLED idle time goes to a fully blank screen or the animated low-contrast screensaver. Editing requires the current station Wi-Fi password or the node setup password.</p>");
    ...
    html += F("<section id='wifi-config'><h2>Configure Wi-Fi</h2><div class='notice'><strong>Fast import:</strong> browsers cannot read saved Wi-Fi passwords directly, but many phones and PCs can copy or share a saved network as text or a QR payload. Paste that copied Wi-Fi share text here, use the clipboard button below, or pick a nearby SSID from the scan dropdown.</div>");
